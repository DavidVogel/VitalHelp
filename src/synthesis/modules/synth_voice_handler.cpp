...
namespace vital {
  ...
  /**
   * @brief Constructs the SynthVoiceHandler, setting up basic processors and outputs.
   *
   * Initializes voice output processors and registers them. Sets up fields that will be
  ...
  /**
   * @brief Initializes all components of the SynthVoiceHandler.
   *
   * Sets up note articulation, producers (oscillators, sampler), modulation sources (LFOs, envelopes, random LFOs),
   * filters, voice outputs, and modulation connections. Establishes all modulation and status outputs for external use.
   */
  ...
  /**
   * @brief Prepares the handler for destruction by removing modulation processors.
   */
  ...
  /**
   * @brief Processes the audio for the specified number of samples across all active voices.
   *
   * Handles resetting voices if needed, updates active voice count and triggers, and processes modulation.
   * Accumulates the resulting audio into the configured outputs.
   */
  ...
  /**
   * @brief Responds to note-on events, triggering voices and potentially retriggering envelopes if needed.
   */
  ...
  /**
   * @brief Responds to note-off events, releasing voices or retriggering them under certain conditions (e.g., legato).
   */
  ...
  /**
   * @brief Determines if a given output should be voice-accumulated or not,
   * allowing certain modulation outputs to remain per-voice without summation.
   */
  ...
  /**
   * @brief Adjusts time-dependent parameters of LFOs and random LFOs to align with a given playback time.
   */
  ...
  /**
   * @brief Disables mod sources that are not currently needed, saving processing.
   */
  ...
  /**
   * @brief Disables a specific modulation source by name (except env_1).
   */
  ...
  /**
   * @brief Enables a given modulation connection processor, making its modulation active in the voice chain.
   */
  ...
  /**
   * @brief Disables a given modulation connection processor, removing its modulation from the active chain.
   */
  ...
  /**
   * @brief Retrieves a map of polyphonic modulation outputs for external monitoring or further processing.
   */
