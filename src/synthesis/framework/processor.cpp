/**
 * @file processor.cpp
 * @brief Implements the Processor class and utility functions for handling
 *        audio/control-rate signal processing, input/output registration, and connections.
 */
...
namespace vital {
  ...
  /**
   * @brief Constructs a Processor with specified counts of inputs and outputs,
   *        control rate mode, and oversampling.
   * @param num_inputs      Number of inputs to allocate.
   * @param num_outputs     Number of outputs to allocate.
   * @param control_rate    Whether the Processor is control rate (1 sample).
   * @param max_oversample  Maximum oversampling factor for its outputs.
   */
