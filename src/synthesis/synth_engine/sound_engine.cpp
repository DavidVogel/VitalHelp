...
namespace vital {
  ...
  void SoundEngine::init() {
    // Initialize base controls and parameters.
    ...
    // Connect compressor status outputs.
  ...
  void SoundEngine::connectModulation(const modulation_change& change) {
    // Connects modulation sources and destinations according to the given change descriptor.
  ...
  void SoundEngine::disconnectModulation(const modulation_change& change) {
    // Disconnects previously connected modulation.
  ...
  void SoundEngine::setOversamplingAmount(int oversampling_amount, int sample_rate) {
    // Adjusts oversampling based on the sample rate.
  ...
  void SoundEngine::process(int num_samples) {
    ...
    // Process modulations even if no voices are active, to keep state updated.
  ...
  void SoundEngine::correctToTime(double seconds) {
    // Correct internal timing to an absolute time.
