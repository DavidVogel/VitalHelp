...
/// @brief Implements the AboutSection class which shows application details, device settings, and GUI scaling options.
...
namespace {
  /// Recursively sets a given colour ID for a component and all its children.
