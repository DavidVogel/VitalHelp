...
MasterControlsInterface::MasterControlsInterface(
  ...
  // If synth mode is enabled, create advanced oscillator sections.
  if (synth) {
  ...
  // Create and add sub-sections for voice, oversampling, display, and output analysis.
...
void MasterControlsInterface::resized() {
  ...
  // If oscillator sections are present, position settings sections below them.
  ...
  // Layout voice settings to the left.
  ...
  // Place oversampling settings above display settings.
  ...
  // Output displays occupy the remaining right side.
