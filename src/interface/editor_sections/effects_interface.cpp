/// @file effects_interface.cpp
/// @brief Implements the EffectsInterface class, managing and displaying multiple effects sections with scrolling and ordering.
...
/// @brief A container holding all the effect sections, painting their background and shadows.
class EffectsContainer : public SynthSection {
  public:
    /// Constructor.
    EffectsContainer(String name) : SynthSection(name) { }

    /// Paints the background behind the effects and their shadows.
