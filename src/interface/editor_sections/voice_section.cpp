...
void VoiceSection::resized() {
  ...
  // Layout for polyphony and pitch bend sliders
  ...
  // Layout for velocity track and stereo routing
  ...
  // Layout for stereo mode text and selector
