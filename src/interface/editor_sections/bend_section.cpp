/// @file bend_section.cpp
/// @brief Implements the BendSection, PitchWheel, and ModWheel classes.
...
/// Called when the parent hierarchy changes, updates parent_ if needed.
...
/// Constructor for ModWheel.
ModWheel::ModWheel() : ControlWheel("mod_wheel") { }

/// Constructor for PitchWheel.
