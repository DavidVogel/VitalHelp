/// @file authentication_section.cpp
/// @brief Implements the AuthenticationSection class and related functionality for user authentication.
...
namespace {
  ...
  // Callback called when the token result is retrieved from Firebase.
  ...
  // Callback called when the login result is retrieved from Firebase.
