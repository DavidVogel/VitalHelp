...
namespace {
  /**
   * @brief Converts a dB value to OpenGL Y coordinates (-1 to 1) for rendering.
   * @param db The decibel value to convert.
   * @return The converted Y value in OpenGL space.
   */
  ...
  /**
   * @brief Converts a poly_float dB value to OpenGL Y coordinates.
   * @param db The poly_float decibel value.
   * @return The clamped OpenGL Y coordinates.
   */
  ...
  /**
   * @brief Converts a magnitude value to OpenGL Y coordinates via dB conversion.
   * @param magnitude The magnitude (linear) value.
   * @return The corresponding OpenGL Y coordinate.
   */
  ...
  /**
   * @brief Sets a quad in an OpenGlMultiQuad if the ratio matches certain conditions.
   * @param quads The quad structure to modify.
   * @param ratio The ratio value to check.
   * @param ratio_match The target ratio match value.
  ...
  /**
   * @brief Formats a float value into a string with a suffix, truncated to a certain decimal length.
   * @param value The float value.
   * @param suffix A string suffix to append.
   * @return A std::string of the formatted value.
   */
