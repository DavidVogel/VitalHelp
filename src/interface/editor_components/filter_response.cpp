...
namespace {
  /**
   * @brief Returns the appropriate shader enum for a given filter model and style.
   * @param model The filter model enum.
   * @param style The style (e.g., 12dB, 24dB).
   * @return The corresponding FilterShader enum value.
   */
  ...
  /**
   * @brief Maps the FilterShader enum to the corresponding vertex shader.
   * @param shader The FilterShader enum.
   * @return The corresponding Shaders::VertexShader enum value.
   */
  ...
  /**
   * @brief Helper to get mono outputs from a given name.
   * @param mono_modulations The map of mono modulation outputs.
   * @param name The parameter name.
   * @return A pair of outputs (mono output and null).
   */
  ...
  /**
   * @brief Helper to get both mono and poly outputs from a given name.
   * @param mono_modulations The map of mono modulation outputs.
   * @param poly_modulations The map of poly modulation outputs.
   * @param name The parameter name.
   * @return A pair of outputs (mono and poly).
   */
  std::pair<vital::Output*, vital::Output*> getOutputs(const vital::output_map& mono_modulations,
