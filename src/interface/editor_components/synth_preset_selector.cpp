/// @file synth_preset_selector.cpp
/// @brief Implements the SynthPresetSelector class and related functionality.
...
namespace {
  /// @brief Callback for handling popup menu selections.
  /// @param result The selected menu item ID.
  /// @param preset_selector Pointer to the SynthPresetSelector instance.
  ...
  /// @brief Redacts an email address for privacy by replacing trailing characters with '*'.
  /// @param email The email string to redact.
  /// @return A partially redacted email.
