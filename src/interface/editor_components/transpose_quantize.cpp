/// @file transpose_quantize.cpp
/// @brief Implements the TransposeQuantizeCallOut and TransposeQuantizeButton classes.
...
namespace {
  /// Sets the bounds of the note key areas in a hexagonal layout.
  /// @param bounds Array of Rectangles to fill with key bounds.
  /// @param y The top y-coordinate to start placing keys.
  /// @param width The total width available.
  /// @param height The total height available.
